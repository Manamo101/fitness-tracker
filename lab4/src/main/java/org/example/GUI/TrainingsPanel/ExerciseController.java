...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel4.setPreferredSize(new Dimension(250, 10));
        panel2.add(panel4);
        final JPanel panel5 = new JPanel();
        panel5.setLayout(new FlowLayout(FlowLayout.CENTER, 5, 5));
        panel5.setMinimumSize(new Dimension(10, 10));
        panel5.setPreferredSize(new Dimension(50, 10));
        panel2.add(panel5);
    ...
    ExerciseController(JList<String> list, JComboBox<String> comboBox, String trainingName, int model) {
        ...
        if (model == 1) {
            ...
            HashMap<String, String> hashMap = ProgramOperation.getListedExercises(list.getSelectedValue());
